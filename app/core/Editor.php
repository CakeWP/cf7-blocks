...
/**
 * Main class for handling related core editor functionalities.
 */
class Editor {
	...
	public function __construct() {
		add_action( 'template_redirect', array( $this, 'setup_media' ) );
	...
	public function block_editor_settings_all( array $settings ) {
		$settings['availableLegacyWidgets']        = (object) array();
